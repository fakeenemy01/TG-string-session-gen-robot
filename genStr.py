...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Group', url='https://t.me/silytalks'),
                InlineKeyboardButton('Developer', url='https://t.me/FakeEnemy01')
            ],
            [
                InlineKeyboardButton('Bots Updates Channel', url='https://t.me/everythingherebyfakeenemy'),
            ]
        ]
    )
